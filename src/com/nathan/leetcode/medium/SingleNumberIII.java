...
//Given an array of numbers nums, in which exactly two elements appear only once and all the others elements appear exactly twice. Find the two elements that appear only once.
//
//        For example:
//
